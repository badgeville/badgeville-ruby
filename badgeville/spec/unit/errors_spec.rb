  ...
  describe Errors do
    ...
    context "where the JSON string is missing the root key :errors" do
      before do
        ...
        @mock_error.from_badgeville_json( json_no_root_key )
      end
    ...
    context "where the JSON string has a root key :errors" do
      before do
        ...
        @mock_error.from_badgeville_json( json_w_root_key )
      end
    ...
    context "where the JSON string has a root key :errors, and a nested key :errors" do
      before do
        ...
        @mock_error.from_badgeville_json( @json_two_errors_keys )
      end
    ...
    context "where the JSON string has a root key :errors, but the value at the key is an empty hash" do
      before do
        ...
        @mock_error.from_badgeville_json( json_root_val_empty )
      end
    ...
    context "where the JSON string is an empty" do
      before do
        @empty_string = ''
        @mock_error.from_badgeville_json( @empty_string )
      end
